CREATE DATABASE  IF NOT EXISTS `ourbank` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ourbank`;
-- MySQL dump 10.13  Distrib 5.5.16, for Mac OS
--
-- Host: localhost    Database: ourbank
-- ------------------------------------------------------
...
INSERT INTO `bank_client_login` VALUES (12,'mindtree','52c9667637c51c398c5088494544be28','1234');
